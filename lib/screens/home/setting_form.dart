...
import 'package:profile/shared/loading.dart';
              ...
              child: Column(
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    decoration: textInputDecoration,
                    validator: (val) =>
                        val.isEmpty ? 'Please enter a address' : null,
                    onChanged: (val) => setState(() => _currentAlamat = val),
                  ),
                  SizedBox(height: 10.0),
                  TextFormField(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState.validate()) {
                          await DatabaseService(uid: user.uid).updateUserData(
                              ...
                              _currentAlamat ?? userData.alamat,
